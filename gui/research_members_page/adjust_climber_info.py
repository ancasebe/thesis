...
class AdjustClimberInfoPage(QWidget):
    """
    ...
    def __init__(self, admin_id, email, switch_to_research_members, db_manager):
    ...
    def populate_data(self):
        ...
        climber_data = self.db_manager.get_user_data(self.admin_id, self.email)
    ...
    def handle_save(self):
        ...
        success = self.db_manager.update_climber_data(self.admin_id, self.email, updated_data)
